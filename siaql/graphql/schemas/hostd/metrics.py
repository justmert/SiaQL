...
class MetricsQueries:
    ...
    async def metrics(self, info: Info, timestamp: Optional[datetime] = None) -> Metrics:
        ...
        return await HostdBaseResolver.handle_api_call(info, "get_metrics", timestamp=timestamp)
    ...
    async def period_metrics(
        ...
        return await HostdBaseResolver.handle_api_call(
            info, "get_period_metrics", start=start, periods=periods, interval=interval
        )
