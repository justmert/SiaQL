...
class BusQueries(RenterdBaseResolver):
    ...
    async def add_account_balance(
        ...
        info: Info,
        account_id: str,
        request: AccountsAddBalanceRequest
    ) -> bool:
    ...
    async def update_account_balance(
        ...
        info: Info,
        account_id: str,
        request: AccountsUpdateBalanceRequest
    ) -> bool:
    ...
    @strawberry.mutation
    async def requires_sync_account(
        self,
        info: Info,
        account_id: str,
        request: AccountsRequiresSyncRequest
    ) -> bool:
        """Mark account as requiring sync"""
        await self.handle_api_call(
            info,
            "requires_sync_account",
            account_id=account_id,
            request = request
        )
        return True
    ...
    @strawberry.mutation
    async def create_bucket(self, info: Info, name: str, 
                          policy: BucketPolicy) -> bool:
        """Create a new bucket"""
        await RenterdBaseResolver.handle_api_call(
            info,
            "create_bucket",
    ...
    @strawberry.mutation
    async def update_bucket_policy(self, info: Info, name: str, 
                                 policy: BucketPolicy) -> bool:
    ...
    @strawberry.mutation
    async def acquire_contract(self, info: Info, contract_id: str, duration: DurationMS, priority: int) -> ContractAcquireResponse:
        """Acquire contract"""
        return await RenterdBaseResolver.handle_api_call(
            info,
            "acquire_contract",
    ...
    @strawberry.mutation
    async def post_contract_keepalive(
        self,
        info: Info,
        contract_id: str,
        request: ContractKeepaliveRequest
    ) -> bool:
        """Extend duration on an already acquired lock"""
        await self.handle_api_call(
            info,
            "post_contract_keepalive",
            contract_id=contract_id,
            request=request
        )
        return True
    ...
    async def archive_contracts(
        self,
        info: Info,
        to_archive: Dict[FileContractID, str]
    ) -> bool:
        """Archive contracts"""
        await self.handle_api_call(
            info,
            "post_contracts_archive",
    ...
    async def contracts_renewed(self, info: Info, contract_id: str) -> ContractMetadata:
        ...
        return await self.handle_api_call(
            info,
            "get_contracts_renewed",
            contract_id=contract_id
        )
    

    @strawberry.mutation
    async def put_contract_set(
        self,
        info: Info,
        set_name: str,
        contract_ids: List[FileContractID]
    ) -> bool:
    ...
    @strawberry.mutation
    async def record_contract_spending(
        self,
        info: Info,
        records: List[ContractSpendingRecord]
    ) -> bool:
        """Record contract spending"""
        await self.handle_api_call(
            info,
            "post_contracts_spending",
            records=records
        )
        return True
    ...
    @strawberry.mutation
    async def update_hosts_allowlist(
        self,
        info: Info,
    ...
    @strawberry.mutation
    async def update_hosts_blocklist(
        self,
        info: Info,
    ...
    @strawberry.mutation
    async def record_hosts_interactions(
        self,
        info: Info,
        interactions: List[HostScan]
    ) -> bool:
        """Record host interactions"""
        await self.handle_api_call(
            info,
            "post_hosts_interactions",
            interactions=interactions
        )
        return True
    
    @strawberry.mutation
    async def remove_hosts(self, 
                         info: Info, 
                         request: HostsRemoveRequest
                         ) -> int:
    ...
    @strawberry.mutation
    async def complete_multipart_upload(self, info: Info, request: MultipartCompleteRequest) -> MultipartCompleteResponse:
    ...
    @strawberry.mutation
    async def list_multipart_upload_parts(self, info: Info, request: MultipartListPartsRequest) -> MultipartListPartsResponse:
    ...
    @strawberry.mutation
    async def list_multipart_uploads(self, info: Info, request: MultipartListUploadsRequest) -> MultipartListUploadsResponse:
    ...
    async def slabs_for_migration(self, info: Info, request: MigrationSlabsRequest) -> SlabsForMigrationResponse:
        ...
        return await RenterdBaseResolver.handle_api_call(
            info,
            "get_slabs_for_migration",
            request=request
        )


    @strawberry.field
    async def get_partial_slab(self, 
                              info: Info, 
                              key: EncryptionKey,
                              offset: int,
                              length: int) -> bytes:
    ...
    @strawberry.mutation
    async def add_partial_slab(self,
                              info: Info,
                              data: bytes,
                              min_shards: int,
                              total_shards: int) -> AddPartialSlabResponse:
        """Add a partial slab"""
        return await RenterdBaseResolver.handle_api_call(
            info,
            "add_partial_slab",
    ...
    @strawberry.mutation
    async def prepare_form_contract(self, 
                                  info: Info, 
                                  request: ContractFormRequest) -> RHPFormResponse:
        """Prepare contract formation"""
        return await RenterdBaseResolver.handle_api_call(
            info,
            "prepare_form_contract",
            request=request
        )

    @strawberry.mutation
    async def prepare_renew_contract(self,
                                   info: Info,
                                   request: ContractRenewRequest) -> RHPFormResponse:
        """Prepare contract renewal"""
        return await RenterdBaseResolver.handle_api_call(
            info,
            "prepare_renew_contract",
            request=request
        )
    ...
    async def sign_transaction(self, 
                             info: Info, 
                             request: WalletSignRequest) -> Transaction:
        """Sign a transaction"""
        return await RenterdBaseResolver.handle_api_call(
            info,
            "sign_transaction",
    ...
    @strawberry.field
    async def metrics(self, info: Info, key: str, start: str, n: int, 
                     interval: str) -> List[Any]:
        """Get metrics"""
        return await RenterdBaseResolver.handle_api_call(
            info,
            "get_metrics",
    ...
    @strawberry.field
    async def gouging_settings(self, info: Info) -> GougingSettings:
        """Get gouging settings"""
        return await RenterdBaseResolver.handle_api_call(
            info,
            "get_gouging_settings"
        )

    @strawberry.field
    async def upload_settings(self, info: Info) -> UploadSettings:
        """Get upload settings"""
        return await RenterdBaseResolver.handle_api_call(
            info,
            "get_upload_settings"
    ...
    @strawberry.field
    async def object_stats(self, info: Info, bucket: Optional[str] = None) -> ObjectsStatsResponse:
        """Get object statistics"""
        return await RenterdBaseResolver.handle_api_call(
            info,
            "get_object_stats",
    ...
    @strawberry.field
    async def contract_metrics(self, info: Info, start: TimeRFC3339, n: int, 
                             interval: DurationMS, opts: ContractMetricsQueryOpts) -> List[ContractMetric]:
    ...
    @strawberry.field
    async def contract_prune_metrics(self, info: Info, start: TimeRFC3339, n: int,
                                   interval: DurationMS, opts: ContractPruneMetricsQueryOpts) -> List[ContractPruneMetric]:
        """Get contract prune metrics"""
        return await RenterdBaseResolver.handle_api_call(
            info,
            "get_contract_prune_metrics",
            start=start,
            n=n,
            interval=interval,
            opts=opts
    ...
    # @strawberry.mutation
    # async def abort_multipart_upload(self, info: Info, bucket: str, key: str, upload_id: str) -> bool:
    #     """Abort multipart upload"""
    #     await RenterdBaseResolver.handle_api_call(
    #         info,
    #         "abort_multipart_upload",
    ...
    @strawberry.field
    async def contract_metrics(self, info: Info, start: TimeRFC3339, n: int, interval: DurationMS, opts: ContractMetricsQueryOpts) -> List[ContractMetric]:
        """Get contract metrics"""
        return await RenterdBaseResolver.handle_api_call(
            info,
            "get_contract_metrics",
    ...
    @strawberry.field
    async def wallet_metrics(self, info: Info, start: TimeRFC3339, n: int, interval: DurationMS, opts: WalletMetricsQueryOpts) -> List[WalletMetric]:
        """Get wallet metrics"""
        return await RenterdBaseResolver.handle_api_call(
            info,
            "get_wallet_metrics",
    ...
    @strawberry.field
    async def s3_settings(self, info: Info) -> S3Settings:
        """Get S3 settings"""
        return await RenterdBaseResolver.handle_api_call(
            info,
            "get_s3_settings"
...
class BusMutations(RenterdBaseResolver):
    @strawberry.mutation
    async def save_accounts(self, info: Info, accounts: List[Account]) -> bool:
        """Save accounts"""
        await RenterdBaseResolver.handle_api_call(
            info,
            "save_accounts",
    ...
    @strawberry.mutation
    async def update_gouging_settings(self, info: Info, settings: GougingSettings) -> bool:
        """Update gouging settings"""
        await RenterdBaseResolver.handle_api_call(
            info,
            "update_gouging_settings",
            settings=settings
        )
        return True

    @strawberry.mutation
    async def update_upload_settings(self, info: Info, settings: UploadSettings) -> bool:
    ...
    @strawberry.mutation
    async def update_slab(self, info: Info, key: EncryptionKey, sectors: List[UploadedSector]) -> bool:
        """Update slab"""
        await RenterdBaseResolver.handle_api_call(
            info,
            "update_slab",
    ...
    @strawberry.mutation
    async def connect_syncer(self, info: Info, addr: str) -> bool:
        """Connect syncer to peer"""
        await RenterdBaseResolver.handle_api_call(
            info,
            "connect_syncer",
            addr=addr
    ...
    @strawberry.mutation
    async def record_contract_prune_metric(self, info: Info, metrics: List[ContractPruneMetric]) -> bool:
        """Record contract prune metrics"""
        await RenterdBaseResolver.handle_api_call(
            info,
            "record_contract_prune_metric",
            metrics=metrics
        )
        return True

    @strawberry.mutation
    async def prune_metrics(self, info: Info, metric: str, cutoff: TimeRFC3339) -> bool:
        """Prune metrics"""
        await RenterdBaseResolver.handle_api_call(
            info,
            "prune_metrics",
    ...
    @strawberry.mutation
    async def archive_contracts(self, info: Info, contracts: Dict[str, str]) -> bool:
        """Archive contracts"""
        await RenterdBaseResolver.handle_api_call(
            info,
            "archive_contracts",
    ...
    @strawberry.mutation
    async def record_contract_metric(self, info: Info, metrics: List[ContractMetric]) -> bool:
        """Record contract metrics"""
        await RenterdBaseResolver.handle_api_call(
            info,
            "record_contract_metric",
            metrics=metrics
        )
        return True
    ...
    @strawberry.mutation
    async def update_s3_settings(self, info: Info, settings: S3Settings) -> bool:
        """Update S3 settings"""
        await RenterdBaseResolver.handle_api_call(
            info,
            "update_s3_settings",
    ...
    @strawberry.mutation
    async def update_pinned_settings(self, info: Info, settings: PinnedSettings) -> bool:
        """Update pinned settings"""
        await RenterdBaseResolver.handle_api_call(
            info,
            "update_pinned_settings",
            settings=settings
        )
        return True

    @strawberry.mutation
    async def backup_database(self, info: Info, database: str, path: str) -> bool:
        """Backup database"""
        await RenterdBaseResolver.handle_api_call(
            info,
            "backup",
    ...
    @strawberry.field
    async def metrics(self, info: Info, key: str, params: Dict[str, Any]) -> Any:
        """Get metrics for given key"""
        return await self.handle_api_call(
            info,
            "get_metrics",
            key=key,
